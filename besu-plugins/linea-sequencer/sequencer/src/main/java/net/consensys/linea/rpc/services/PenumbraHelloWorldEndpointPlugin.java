...
import net.consensys.linea.rpc.methods.PenumbraHelloWorld;
...
@Slf4j
public class PenumbraHelloWorldEndpointPlugin extends AbstractLineaRequiredPlugin {

  private TransactionSimulationService transactionSimulationService;
  private PenumbraHelloWorld helloWorldMethod;
  ...
  public void doRegister(final ServiceManager serviceManager) {
    ...
    helloWorldMethod =
        new PenumbraHelloWorld(
            besuConfiguration, transactionSimulationService, blockchainService, rpcEndpointService);

    rpcEndpointService.registerRPCEndpoint(
        helloWorldMethod.getNamespace(),
        helloWorldMethod.getName(),
        helloWorldMethod::execute);
  }
